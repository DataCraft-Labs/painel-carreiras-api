...
class Salary(Base):
    ...
    max_salary: Mapped[Decimal] = mapped_column(
        ...
        Numeric(scale=2),
        nullable=True,
        doc="Maximum potential salary based on performance and promotions",
    )
    currency: Mapped[str] = mapped_column(
        "currency", String(length=3), default="USD", doc="Currency in which the salary and compensation are paid"
    )
